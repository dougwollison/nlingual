...
for(r in n=s(this),t=s("#nl_language_preset"),i=s("#nl_language_list"),a=s("#nl_language_add"),d=s("#nl_language_row").text(),l=-1,
// Setup sortability
i.sortable({items:"tr",containment:"parent",handle:".handle"}),g.presets)t.append('<option value="'+r+'">'+g.presets[r].system_name+"</option>");u.each(e),
// Add button functionality
a.click(function(){var n,a;
// Check if preset was selected,
// otherwise make blank language
t.val()?(a=t.val(),(n=new o(g.presets[a])).set("iso_code",a),
...
n="nlLocalizerSkipUpdate",i.each(function(n){var a,t,e,l,i,d,r,o;a=n.get("field_id"),t=n.get("values"),e=n.get("nonce"),l=!1,0!==(
...
(a=s(this).parents(".nl-translations-manager")).find(".nl-set-translations").toggleClass("hidden","0"===n),
