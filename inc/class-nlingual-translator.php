...
class Translator {
	 ...
	 */
	public static function url_process_domain( $host, &$lang = false ) {
	 ...
	 */
	public static function url_process_path( $path, &$lang = null ) {
	 ...
	 */
	public static function url_process( $url_data = null ) {
		$lang = null;
		...
		switch( Registry::get( 'detection_method' ) ) {
			case 'subdomain':
				$url_data['host'] = static::url_process_domain( $url_data['host'], $url_data['lang'] );
				break;
			case 'subdirectory':
				$url_data['path'] = static::url_process_path( $url_data['path'], $url_data['lang'] );
				break;
		}
