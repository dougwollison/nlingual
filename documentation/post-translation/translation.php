...
<?php else: ?>
	...
	_emf( 'The **Languages & Translations** box allows you to assign a language for this %1$s, from the list of languages that have been registered [here]^(%2$s) for use. Once a language is assigned, you can create/access translated versions for the other languages.', 'nlingual', $singular, admin_url( 'admin.php?page=nlingual-languages' ) ); ?></p>
<?php endif; ?>
...
_emf( 'When you save your changes, certain fields and settings will be copied to its sister translations, synchronizing them. The exact fields/settings that will be synchronized is controlled [here]^(%s).', 'nlingual', admin_url( 'admin.php?page=nlingual-synchronizer' ) ); ?></p>
