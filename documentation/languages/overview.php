...
<ul>
	<li><strong><?php _e( 'System Name:', 'nlingual' );?></strong> <?php _e( 'the name of the language in your native tongue for easy recognition.', 'nlingual' );?></li>
...
<p><?php _e( 'Registered languages can be deactivated, hiding them from being publicly accessible, and excluding them from the All Languages filter in the post listing. The language will still however be available for assigning posts and translations to.', 'nlingual' ); ?></p>
