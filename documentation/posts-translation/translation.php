...
<?php if ( nLingual\Registry::get( 'lock_post_language' ) ) : ?>
	...
	echo nLingual\markitup( _f( 'The **Quick Edit** option will allow you to quickly select/change the assigned translations for a %1$s.', 'nlingual', $singular, $plural ) ); ?></p>
<?php else: ?>
	<p><?php
	...
	echo nLingual\markitup( _f( 'The **Quick Edit** option will allow you to quickly select/change the language or assigned translations for a %1$s, while Bulk Edit will allow you to change the language of many %2$s at once.', 'nlingual', $singular, $plural ) ); ?></p>
<?php endif; ?>
