...
<p><?php _e( '<strong>Caution:</strong> these sync rules cannot be disabled on a per-post basis; either all post of a particular type have these details synchronized or none of them do.', 'nlingual' ); ?></p>
