...
<p><?php _e( 'Since translations are intended to be somewhat synchronized, you may want to enable synchronized trashing and/or deleting of posts, for cleaner management of content.', 'nlingual' ); ?></p>

<p><?php _e( 'Depending on the workflow of you and your editors, you may want to enforce that all new content is in the default language, and prevent languages from being changed after the fact.', 'nlingual' ); ?></p>
