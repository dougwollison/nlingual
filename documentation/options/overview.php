...
<p><?php _e( 'To control what site the language falls back to in for visitors who prefer and unsupported or undetected language, select a language as the Default Language.', 'nlingual' ); ?> <?php _e( 'If your site uses languages that have their own handling of date formats, check the Localized Date box and/or the Patch WP_Locale box, depending on what your setup is.', 'nlingual' ); ?></p>

<p><?php _e( 'By default, posts of supported types are created with no language assigned.', 'nlingual' ); ?> <?php _e( 'You can force all new posts to be created in the default language, meaning that posts in other languages can only be created via the Create Translation feature.', 'nlingual' ); ?></p>
